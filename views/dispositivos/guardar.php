...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO dispositivos (equipo, modelo, serie, mac, sucursal, area, estado, fecha, observaciones, imagen, imagen2) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssssssss", $equipo, $modelo, $serie, $mac, $sucursal, $area, $estado, $fecha, $observaciones, $imagen, $imagen2);
    $stmt->execute();
