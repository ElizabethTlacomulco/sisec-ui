<!-- Topbar -->
<header class="topbar d-flex align-items-center justify-content-between px-3 py-2" style="background-color: #3C92A6 !important; color: white;">
  ...
  <!-- Título -->
  <h5 class="m-0 flex-grow-1 text-white"><?= htmlspecialchars($pageHeader ?? 'SISEC') ?></h5>
  ...
  <div class="topbar-icons me-3">
    <div class="dropdown position-relative" title="Notificaciones">
      <?php if (isset($_SESSION['usuario_rol']) && $_SESSION['usuario_rol'] === 'Administrador'): ?>
        <a href="#" id="notifDropdown" class="text-white" data-bs-toggle="dropdown" aria-expanded="false" style="text-decoration:none; position:relative;">
          ...
          <?php if ($notificaciones_no_vistas > 0): ?>
            <span class="notification-badge position-absolute top-0 start-100 translate-middle p-1 bg-danger border border-light rounded-circle"></span>
          <?php endif; ?>
        </a>
      ...
      <?php else: ?>
        <i class="fas fa-bell text-white-50"></i>
      <?php endif; ?>
    </div>
  </div>
